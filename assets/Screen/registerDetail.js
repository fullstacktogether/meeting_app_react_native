    ...
    const uploadAvatar = async () => {
        ...
        fetch("http://192.168.1.106:3000/api/auth/me", {
            ...
            headers: {
                ...
                Authorization:
                    "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjA0NGRjZDFjMGMwYzEyMDA4MDE0YzgzIiwiaWF0IjoxNjE1MTI1NzEzLCJleHAiOjE2NDY2NjE3MTN9.QCy_bvqZ3ZZObtqm2IATiUBAHM_1eHhvnCjqUVgAQ40",
            },
            body: form,
        })
            .then((res) => res.json())
        ...
        <View style={styles.conteiner}>
            <View style={styles.top}>
                ...
                <Text style={styles.text}>
                    Let's choose an interesting profile photo to highlight your
                    profile for you.
                </Text>
            </View>
