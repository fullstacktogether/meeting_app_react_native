        ...
        <View style={styles.conteiner}>
            <View style={styles.top}>
                ...
                <Text style={styles.text}>
                    Let's choose an interesting cover photo to highlight your
                    event for you.
                </Text>
            </View>
            <View style={styles.main}>
                ...
                <Text style={styles.text}>
                    Please notice that everyone will be able to see this photo.
                </Text>
            ...
            <Animated.View
                style={[styles.bottomSheet, { bottom: bottomValue }]}
            >
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.bottomPrivacy}>
                        ...
                        <Pressable
                            ...
                            style={[styles.publicityButton, { marginLeft: 20 }]}
                        >
